...
console.log("Ahinsa-X-MD Session downloaded ✅")
})})}
...
console.log("Connecting Ahinsa-X-MD 🧬...");
...
console.log('Ahinsa-X-MD connected to whatsapp ✅')

let up = `
_________________________________________
🚀 **Ahinsa-X-MD Connected Successfully!** ✅ 

--- **🎉 Welcome to Ahinsa-X-MD!** 🎉 

**🔹 PREFIX:** ${prefix}

**🔹 OWNER:**  ${ownerNumber}

--- Thank you for using **Ahinsa-X-MD**. 
...
app.get("/", (req, res) => {
res.send("hey I am alive, Ahinsa-X-MD Is started✅");
});
